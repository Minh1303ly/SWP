                        ...
                        <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-12">
                            ...
                            <form action="OrderDetailAdmin" method="post" class="my-4 grid grid-cols-1 gap-4 md:grid-cols-12">
                                ...
                                <div class="md:col-span-5">
                                    ...
                                    <input value="${order.notes}" type="text" name="note" class="mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <select name="status" id="status" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                        ...
                                        <option value="3"<c:if test="${order.getOrderStatus().name == 'Failed'}">selected</c:if>>Failed</option>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <c:forEach items="${users}" var="u">
                                            <c:if test="${u.role_id == 3}">
                                                <option value="${u.id}" <c:if test="${order.saleId == u.id}">selected</c:if>>${u.first_name} ${u.last_name}</option>
                                            </c:if>
                                        </c:forEach>
