                                ...
                                <div class="">
                                    <div class="flex flex-wrap justify-between">
                                        <div class="items-center ">
                                            <h1 class="font-medium text-3xl block dark:text-slate-100">Permissions</h1>
                                            <ol class="list-reset flex text-sm">
                                                <li><a href="#" class="text-gray-500 dark:text-slate-400">Robotech</a></li>
                                                <li><span class="text-gray-500 dark:text-slate-400 mx-2">/</span></li>
                                                <li class="text-gray-500 dark:text-slate-400">Marketing</li>
                                                <li><span class="text-gray-500 dark:text-slate-400 mx-2">/</span></li>
                                                <li class="text-primary-500 hover:text-primary-600 dark:text-primary-400">Permissions</li>
                                            </ol>
                                        </div>
                                ...
                                <div class="flex-auto p-0 md:p-4">
                                    ...
                                    <div class="border border-gray-300 p-4 rounded-lg shadow-md">
                                        ...
                                        <form action="permissions" method="post" class="mb-4">
                                            ...
                                            <select name="roleId" id="role" class="border p-2 w-full mb-4" required>
                                            ...
                                            <select name="urlId" id="urls" class="border p-2 w-full mb-4" multiple="multiple" required>
